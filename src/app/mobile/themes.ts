...
export const androidTheme: MobileTheme = {
    ...
    accent: {
        ...
        statusDot: (isLight) => isLight ? 'border-[#f9fafb] bg-ds-success' : 'border-[#0b0b13] bg-[#4ade80]',
    ...
    workspace: {
        ...
        statusActive: 'bg-ds-success/15 text-green-400',
        sheetAccent: '#93c5fd',
    ...
    profile: {
        ...
        statBadge: 'bg-ds-success/10 text-[#4ade80]',
        donutPrimary: 'text-[#93c5fd]', donutLabel: 'text-[#93c5fd]',
        engagementActiveBg: 'bg-[#93c5fd]',
        barGradients: ['from-[#a78bfa] to-[#9333ea]', 'from-[#e879f9] to-[#c026d3]', 'from-[#f472b6] to-[#ec4899]', 'from-[#ffb07a] to-[#d96820]', 'from-[#22d3ee] to-[#06b6d4]', 'from-[#ff8c42] to-[#d97706]', 'from-[#818cf8] to-[#4f46e5]'],
    ...
    dashboard: {
        ...
        teamColorMap: { purple: 'bg-[#a855f7]/12 text-[#a78bfa]', blue: 'bg-[#3b82f6]/12 text-[#60a5fa]', emerald: 'bg-ds-success/12 text-[#4ade80]', amber: 'bg-ds-warning/12 text-ds-warning' },
    },
    titles: {
...
export const iosTheme: MobileTheme = {
    ...
    accent: {
        ...
        statusDot: (isLight) => isLight ? 'border-white bg-ds-success' : 'border-black bg-[#4ade80]',
    ...
    profile: {
        ...
        barGradients: ['from-[#60a5fa] to-[#2563eb]', 'from-[#818cf8] to-[#4f46e5]', 'from-[#22d3ee] to-[#06b6d4]', 'from-[#ffb07a] to-[#d96820]', 'from-[#e879f9] to-[#c026d3]', 'from-[#f472b6] to-[#ec4899]', 'from-[#a78bfa] to-[#9333ea]'],
    ...
    dashboard: {
        ...
        teamColorMap: { purple: 'bg-purple-500/12 text-purple-400', blue: 'bg-[#3b82f6]/12 text-[#3b82f6]', emerald: 'bg-ds-success/12 text-ds-success', amber: 'bg-[#FF9500]/12 text-[#FF9500]' },
    },
    titles: {
