...
export const androidTheme: MobileTheme = {
    ...
    accent: {
        ...
        primaryLight: 'var(--color-blue-300)',
    ...
    workspace: {
        ...
        sheetAccent: 'var(--color-blue-300)',
    ...
    dashboard: {
        ...
        teamColorMap: { purple: 'bg-ds-violet-500/12 text-ds-violet-400', blue: 'bg-ds-blue-500/12 text-ds-blue-400', emerald: 'bg-ds-success/12 text-ds-success', amber: 'bg-ds-warning/12 text-ds-warning' },
    },
    titles: {
...
export const iosTheme: MobileTheme = {
    ...
    workspace: {
        ...
        sheetAccent: 'var(--color-blue-400)',
    ...
    profile: {
        ...
        barGradients: ['from-ds-blue-400 to-ds-blue-600', 'from-ds-indigo-400 to-ds-indigo-600', 'from-ds-cyan-400 to-ds-cyan-500', 'from-ds-violet-300 to-ds-violet-700', 'from-ds-fuchsia-400 to-ds-fuchsia-600', 'from-ds-pink-400 to-ds-pink-500', 'from-ds-violet-400 to-ds-violet-600'],
    ...
    dashboard: {
        ...
        teamColorMap: { purple: 'bg-ds-violet-500/12 text-ds-violet-400', blue: 'bg-ds-blue-500/12 text-ds-blue-500', emerald: 'bg-ds-success/12 text-ds-success', amber: 'bg-ds-warning/12 text-ds-warning' },
    },
    titles: {
