        ...
        <div className={`absolute inset-0 z-50 flex flex-col ${bgClass} transition-colors duration-500 overflow-hidden`}>
            ...
            {selectedTheme === 'colorful' && (
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] rounded-full bg-blue-600/10 blur-3xl animate-pulse" style={{ animationDuration: '11s', animationDelay: '5s' }} />
                </div>
            )}
