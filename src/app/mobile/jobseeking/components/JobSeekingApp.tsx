                            ...
                            {theme.navTab.pill ? (
                                <div className="relative w-14 h-8 rounded-full flex items-center justify-center">
                                    ...
                                    <motion.span
                                        ...
                                        className={`relative icon-glyph fa-duotone fa-thin fa-${resolveFontAwesomeName(ic)} ${theme.navTab.iconSize} transition-colors duration-200 ${a ? (isColorful ? 'text-accent' : theme.navTab.active(isLight)) : theme.navTab.inactive(isLight)}`}
                                        aria-hidden="true"
                                    />
                                </div>
                            ) : (
