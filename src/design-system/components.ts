...
export const componentRegistry: ComponentEntry[] = [
  ...
  },
  {
    ...
    category: 'primitive',
    props: [
      { name: 'name', type: 'string', default: 'required', description: 'Semantic icon name (translated to Font Awesome glyph)' },
      ...
      { name: 'variant', type: "'outline' | 'filled'", default: "'outline'", description: 'Duotone layer balance (outline vs. swapped/filled)' },
    ...
    tokens: ['--icon-font-family', '--icon-size-*', '--primary', '--accent-text', '--foreground', '--muted-foreground', '--text-on-primary'],
  ...
  },
  {
    ...
    category: 'primitive',
    props: [
      { name: 'children', type: 'string', default: 'required', description: 'Legacy Material Symbols ligature name, translated to a Font Awesome glyph' },
      { name: 'className', type: 'string', default: "''", description: 'Additional CSS classes' },
    ],
    tokens: ['--icon-font-family'],
    a11y: [],
    variants: [],
  },
  {
  ...
  },
  {
    ...
    props: [
      ...
      { name: 'icon', type: 'string', default: 'undefined', description: 'Semantic icon name (optional if number is provided)' },
