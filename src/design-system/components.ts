...
export const componentRegistry: ComponentEntry[] = [
  ...
  // ─── New Foundation Primitives ─────────────────────────
  {
    ...
    category: 'primitive',
    props: [
      { name: 'variant', type: "'primary' | 'secondary' | 'outline' | 'ghost' | 'cosmic'", default: "'primary'", description: 'Button style variant' },
    ...
    tokens: ['--primary', '--primary-hover', '--gradient-start', '--gradient-mid', '--gradient-end', '--radius-lg'],
    a11y: ['aria-disabled', 'aria-busy', 'focus-visible ring'],
    variants: ['primary', 'secondary', 'outline', 'ghost', 'cosmic'],
  },
  {
    name: 'Badge',
    ...
    tokens: ['--primary', '--radius-full', '--font-size-xs'],
    a11y: ['role="status"'],
  ...
  },
  {
    ...
    tokens: ['--primary', '--radius-md', '--card-border', '--card-border-hover', '--foreground', '--background'],
