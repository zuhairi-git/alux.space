  ...
  if (isColorful) {
    return (
      <div className="absolute inset-0 overflow-hidden bg-[var(--color-colorful-bg)]">
        ...
        <div className="absolute top-0 left-[12%] text-purple-400 text-sm font-mono opacity-40 animate-matrix animation-delay-1000">10</div>
        ...
        <div className="absolute top-0 right-[5%] text-purple-400 text-sm font-mono opacity-40 animate-matrix animation-delay-4000">01</div>
        ...
        <div className="absolute top-0 right-[25%] text-purple-400 text-sm font-mono opacity-40 animate-matrix animation-delay-2000">00</div>
