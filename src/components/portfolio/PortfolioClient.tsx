              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`relative px-4 py-2 text-sm font-medium transition-colors whitespace-nowrap rounded-lg ${
                      isActive
                        ? theme === 'light'
                          ? 'text-gray-900'
                          : 'text-white'
              ...
              {(['standard', 'overlay'] as const).map((mode) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex items-center gap-1.5 px-3.5 py-1.5 rounded-md text-sm font-medium transition-colors ${
                      isActive
