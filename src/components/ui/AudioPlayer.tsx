      ...
      <div className="flex items-center justify-between relative z-20 mb-4" style={{ overflow: 'visible' }}>
        <div className="flex items-center space-x-4 relative z-10" style={{ overflow: 'visible' }}>{/* Main play/pause button - Enhanced for mobile */}
          <motion.button
            ...
            className={`relative ${isMobile ? 'w-16 h-16 min-w-[64px] min-h-[64px]' : 'w-14 h-14'} flex items-center justify-center rounded-full bg-gradient-to-br from-[var(--primary)] to-[var(--gradient-mid)] shadow-lg backdrop-blur-md overflow-hidden group transition-all duration-300 ${
          ...
          <div className={`flex items-center ${isMobile ? 'space-x-4' : 'space-x-3'}`}>
            {/* Stop button - Enhanced for mobile */}            <motion.button
              ...
              whileTap={animationsDisabled ? {} : { scale: 0.9 }}
              whileHover={animationsDisabled || isMobile ? {} : { scale: 1.05 }}
              className={`${isMobile ? 'w-12 h-12 min-w-[48px] min-h-[48px]' : 'w-12 h-12'} flex items-center justify-center rounded-full bg-[var(--card-from-bg)] hover:bg-[var(--card-to-bg)] border border-[var(--card-border)] text-[var(--muted-foreground)] hover:text-[var(--foreground)] shadow-sm hover:shadow-md backdrop-blur-md transition-all duration-200 relative z-10`}
              disabled={loadError}
              aria-label="Stop"
            ...
            {/* Playback rate - Enhanced for mobile */}            <motion.button
              ...
              whileTap={animationsDisabled ? {} : { scale: 0.9 }}
              whileHover={animationsDisabled || isMobile ? {} : { scale: 1.05 }}
              className={`flex items-center justify-center ${isMobile ? 'px-4 h-12 min-w-[64px] min-h-[48px]' : 'px-4 h-10'} rounded-full bg-[var(--card-from-bg)] hover:bg-[var(--card-to-bg)] border border-[var(--card-border)] text-[var(--muted-foreground)] hover:text-[var(--foreground)] text-sm font-semibold shadow-sm hover:shadow-md backdrop-blur-md transition-all duration-200 relative z-10`}
              disabled={loadError}
                ...
                {showShareMenu && (
                  <>
                    ...
                    <div className="fixed inset-0 z-[999998]" style={{ pointerEvents: 'none' }} />
                      ...
                      className="absolute bg-[var(--card-from-bg)] border border-[var(--card-border)] rounded-2xl backdrop-blur-2xl p-4 min-w-[250px]"
                      data-share-menu
                      transition={{ 
                  ...
                  >
                      ...
                      <div className="w-0 h-0 border-solid"
                        style={{
                          borderWidth: dropdownPosition.position === 'top' ? '0 6px 6px 6px' :
                                       ...
                                       '6px 6px 6px 0',
                          borderColor: dropdownPosition.position === 'top' ? `transparent transparent var(--card-from-bg) transparent` :
                                       dropdownPosition.position === 'bottom' ? `var(--card-from-bg) transparent transparent transparent` :
                                       dropdownPosition.position === 'left' ? `transparent transparent transparent var(--card-from-bg)` :
                    ...
                    <div className="space-y-2">
                        <button
                          ...
                          className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium bg-[var(--card-from-bg)] hover:bg-[var(--card-to-bg)] border border-[var(--card-border)] text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-all duration-200 hover:scale-105`}
                        >
        ...
        {!isMobile && (
          <motion.div 
            className={`flex items-center space-x-3 px-4 py-2 rounded-full backdrop-blur-md bg-[var(--card-from-bg)] hover:bg-[var(--card-to-bg)] border border-[var(--card-border)] text-[var(--muted-foreground)] hover:text-[var(--foreground)] text-sm`}
