    ...
    <div className="max-w-4xl mx-auto p-8 space-y-8">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          ...
          <div className={`p-3 rounded ${animationsDisabled ? 'bg-ds-ember/10 dark:bg-ds-ember/30' : 'bg-green-600/10 dark:bg-green-600/30'}`}>
          ...
          <div className="flex gap-4">
            {[1, 2, 3, 4].map((item, index) => (
              <MotionDiv
                ...
                className="bg-ds-ember text-white p-4 rounded w-16 h-16 flex items-center justify-center"
              >
                {item}
              </MotionDiv>
            ))}
