          ...
          >
            <div className="relative">
              ...
              <div className="absolute inset-0 overflow-hidden rounded-3xl pointer-events-none">
                <div className={`absolute -top-10 -start-10 w-40 h-40 rounded-full blur-3xl bg-[var(--primary)]/20`} />
                <div className={`absolute -bottom-10 -end-10 w-40 h-40 rounded-full blur-3xl bg-[var(--gradient-mid)]/20`} />
              </div>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="relative mb-2">
                      ...
                      `}>
                        {item.years}
                        <span className="text-lg md:text-xl ms-1 text-[var(--muted-foreground)]">
                          {locale === 'fi' ? 'v' : 'yrs'}
                        </span>
                      </div>
                    </div>
